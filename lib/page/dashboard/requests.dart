...
class _RequestsState extends State<Requests> {
  ...
  void initState() {
    ...
    _allRequests = BackEnd()
        .getRequests(_currentSubject, widget.currentUser['id'].toString());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
        ...
        builder: (context, child) {
          _allRequests = BackEnd().getRequests(_currentSubject,
              widget.currentUser['id'].toString()); // TODO: await?
