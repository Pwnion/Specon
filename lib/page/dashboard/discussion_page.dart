  ...
  Future<bool?> adjustDueDatePopUp() {
    return showDialog<bool>(
        ...
        builder: (_) => StatefulBuilder(
              builder: (_, setState) => AlertDialog(
                title: Center(
                  child: Text('Please select a new due date',
                      style: TextStyle(
                          color: Theme.of(context).colorScheme.surface)),
                ),
                content: SizedBox(
                  ...
                  child: Column(
                    children: [
                      Slider(
                        ...
                        secondaryTrackValue:
                            widget.currentRequest.daysExtending.toDouble(),
                        label: '${_sliderValue.round().toString()} days',
                        onChanged: (value) {
                          setState(() {
                            _sliderValue = value;
                            _finalDueDateTextController.text =
                          ...
                          Visibility(
                            ...
                            child: TextButton(
                              onPressed: () {
                                ...
                                if (widget.currentRequest.requestType ==
                                    'Extension') {
                                  _sliderValue = widget
                                      .currentRequest.daysExtending
                                      .toDouble();
                                  _proposedDueDateTextController.text =
                                      dateConversionString(
                                          _sliderValue.toInt());
                                  _finalDueDateTextController.text =
                                      _proposedDueDateTextController.text;
                                ...
                                _db
                                    .getEmailFromStudentID(widget
                                        .currentRequest.requestedByStudentID)
                                    .then((studentEmail) =>
                                        sendStudentRequestConsideredEmail(
                                            studentEmail));
                              },
                              style: ButtonStyle(
                          ...
                          Container(
                            ...
                            child: TextButton(
                              onPressed: () => downloadFilesToDisc(
                                  requestRef.id,
                                  widget.currentRequest
                                      .requestedByStudentID), //downloadAttachment, TODO
