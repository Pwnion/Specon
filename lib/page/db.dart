...
class DataBase {
  ...
  Future<List<RequestModel>> getRequests(
    ...
    if (user.role == UserType.subjectCoordinator) {
      ...
      final requestsRef =
          await _db.doc(subject.id!).collection('requests').get();
  ...
  Future<void> submitRequest(
    ...
    // Get subject's reference
    final DocumentReference subjectRef = _db.doc(subject.id!);
  ...
  Future<void> addAssessments(
      List<RequestType> assessments, SubjectModel subject) async {
