...
class DataBase {
  ...
  ///Fetch a [UserModel] from the database from a given email address
  ...
  /// Get the subjects of a specific User
  ...
  /// Submit the request, enter in to the databse in the correct subject
